...
check_register()
{
    ...
    case "$second" in
        *"count=2 reg=$reg low0=00000000$value low1=0000000000000000"*\
*'shadow_high0=0000000000000000 shadow_high1=0000000000000000'*) ;;
        *)
            echo "FAIL xmm$reg vmovd state after first execution" >&2
            sed -n '1,120p' "$output" >&2
            exit 1
            ;;
    esac
...
check_register 0 44332211
check_register 15 4b5a6978
echo "PASS vmovd clears XMM upper 96 and YMM shadow high 128"
