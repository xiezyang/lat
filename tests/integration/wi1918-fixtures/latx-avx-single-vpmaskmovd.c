...
extern void latx_avx_single_vpmaskmovd_run(uint8_t *, uint8_t *);
extern void latx_avx_single_vpmaskmovd_fault_load(uint8_t *, uint8_t *, const uint8_t *);
extern void latx_avx_single_vpmaskmovd_fault_load_ymm(uint8_t *, uint8_t *, const uint8_t *);
extern void latx_avx_single_vpmaskmovd_fault_store(uint8_t *, uint8_t *, const uint8_t *);
extern void latx_avx_single_vpmaskmovd_fault_store_ymm(uint8_t *, uint8_t *, const uint8_t *);
...
{
    static const uint64_t source[] = { UINT64_C(0x0000000011223344), UINT64_C(0x0000000055667788), UINT64_C(0x0000000099aabbcc), UINT64_C(0x00000000ddeeff00), UINT64_C(0x0000000001234567), UINT64_C(0x0000000089abcdef), UINT64_C(0x00000000fedcba98), UINT64_C(0x0000000076543210) };
    static const uint64_t data[] = { UINT64_C(0x000000000f1e2d3c), UINT64_C(0x000000004b5a6978), UINT64_C(0x0000000088776655), UINT64_C(0x0000000044332211), UINT64_C(0x0000000010203040), UINT64_C(0x0000000050607080), UINT64_C(0x0000000090807060), UINT64_C(0x0000000050403020) };
    static const uint64_t mask_zero[] = { UINT64_C(0x0000000000000000), UINT64_C(0x0000000000000000), UINT64_C(0x0000000000000000), UINT64_C(0x0000000000000000), UINT64_C(0x0000000000000000), UINT64_C(0x0000000000000000), UINT64_C(0x0000000000000000), UINT64_C(0x0000000000000000) };
    static const uint64_t mask_one[] = { UINT64_C(0x0000000080000000), UINT64_C(0x0000000080000000), UINT64_C(0x0000000080000000), UINT64_C(0x0000000080000000), UINT64_C(0x0000000080000000), UINT64_C(0x0000000080000000), UINT64_C(0x0000000080000000), UINT64_C(0x0000000080000000) };
    static const uint64_t mask_mix[] = { UINT64_C(0x0000000080000000), UINT64_C(0x0000000000000000), UINT64_C(0x0000000080000000), UINT64_C(0x0000000000000000), UINT64_C(0x0000000080000000), UINT64_C(0x0000000000000000), UINT64_C(0x0000000080000000), UINT64_C(0x0000000000000000) };
    static const uint64_t mask_fault_mix[] = { UINT64_C(0x0000000080000000), UINT64_C(0x0000000000000000), UINT64_C(0x0000000080000000), UINT64_C(0x0000000000000000), UINT64_C(0x0000000080000000), UINT64_C(0x0000000000000000), UINT64_C(0x0000000080000000), UINT64_C(0x0000000000000000) };

    latx_avx_single_fill(p, PAGES * PAGE, UINT64_C(0x564d41534b3138));
    for (unsigned i = 0; i < 8; ++i) {
        set_element(p + SRC + i * 4, source[i]);
        set_element(p + DATA + i * 4, data[i]);
        set_element(p + MASK_ZERO + i * 4, mask_zero[i]);
        set_element(p + MASK_ONE + i * 4, mask_one[i]);
        set_element(p + MASK_MIX + i * 4, mask_mix[i]);
        set_element(p + MASK_FAULT_MIX + i * 4,
                    mask_fault_mix[i]);
    }
...
static int run_zero(uint8_t *target, uint8_t *base, int store, int ymm)
{
    ...
    if (store) {
        if (ymm)
            latx_avx_single_vpmaskmovd_fault_store_ymm(target, base,
                base + MASK_ZERO);
        else
            latx_avx_single_vpmaskmovd_fault_store(target, base,
                base + MASK_ZERO);
    } else if (ymm) {
        latx_avx_single_vpmaskmovd_fault_load_ymm(target, base,
            base + MASK_ZERO);
    } else {
        latx_avx_single_vpmaskmovd_fault_load(target, base,
            base + MASK_ZERO);
    }
    emit_fault_record();
    return 0;
                     ...
                     int mixed)
{
    ...
    if (store) {
        if (ymm)
            latx_avx_single_vpmaskmovd_fault_store_ymm(target, base, mask);
        else
            latx_avx_single_vpmaskmovd_fault_store(target, base, mask);
    } else if (ymm) {
        latx_avx_single_vpmaskmovd_fault_load_ymm(target, base, mask);
    } else {
        latx_avx_single_vpmaskmovd_fault_load(target, base, mask);
    }
    return 91;
}
...
int latx_avx_single_main(long argc, char **argv)
{
    ...
    prepare(page);
    if (argc == 1) {
        latx_avx_single_vpmaskmovd_run(output, page);
