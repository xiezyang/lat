...
void translate_context_init(void)
{
    ...
    if (!option_enable_lasx || !option_avx_cpuid) {
        if (!option_enable_lasx) {
            ...
            translate_register_lsx(dt_X86_INS_VBROADCASTF128,
                                   translate_vbroadcastf128_lsx);
            translate_register_lsx(dt_X86_INS_VBROADCASTI128,
                                   translate_vbroadcasti128_lsx);
            translate_register_lsx(dt_X86_INS_VBROADCASTSD,
                                   translate_vbroadcastsd_lsx);
            translate_register_lsx(dt_X86_INS_VBROADCASTSS,
                                   translate_vbroadcastss_lsx);
            translate_register_lsx(dt_X86_INS_VPBROADCASTB,
                                   translate_vpbroadcastb_lsx);
            translate_register_lsx(dt_X86_INS_VPBROADCASTD,
                                   translate_vpbroadcastd_lsx);
            translate_register_lsx(dt_X86_INS_VPBROADCASTQ,
                                   translate_vpbroadcastq_lsx);
            translate_register_lsx(dt_X86_INS_VPBROADCASTW,
                                   translate_vpbroadcastw_lsx);
            translate_register_lsx(dt_X86_INS_VEXTRACTF128,
                                   translate_vextractf128_lsx);
            translate_register_lsx(dt_X86_INS_VEXTRACTI128,
                                   translate_vextracti128_lsx);
            translate_register_lsx(dt_X86_INS_VEXTRACTPS,
                                   translate_vextractps_lsx);
            translate_register_lsx(dt_X86_INS_VINSERTF128,
                                   translate_vinsertf128_lsx);
            translate_register_lsx(dt_X86_INS_VINSERTI128,
                                   translate_vinserti128_lsx);
            translate_register_lsx(dt_X86_INS_VINSERTPS,
                                   translate_vinsertps_lsx);
            translate_register_lsx(dt_X86_INS_VPEXTRB,
                                   translate_vpextrx_lsx);
            translate_register_lsx(dt_X86_INS_VPEXTRD,
                                   translate_vpextrx_lsx);
            translate_register_lsx(dt_X86_INS_VPEXTRQ,
                                   translate_vpextrx_lsx);
            translate_register_lsx(dt_X86_INS_VPEXTRW,
                                   translate_vpextrx_lsx);
            translate_register_lsx(dt_X86_INS_VPINSRB,
                                   translate_vpinsrx_lsx);
            translate_register_lsx(dt_X86_INS_VPINSRD,
                                   translate_vpinsrx_lsx);
            translate_register_lsx(dt_X86_INS_VPINSRW,
                                   translate_vpinsrx_lsx);
            translate_register_lsx(dt_X86_INS_VBLENDPD,
                                   translate_vblendpd_lsx);
            translate_register_lsx(dt_X86_INS_VBLENDPS,
                                   translate_vblendps_lsx);
            translate_register_lsx(dt_X86_INS_VBLENDVPD,
                                   translate_vblendvpd_lsx);
            translate_register_lsx(dt_X86_INS_VBLENDVPS,
                                   translate_vblendvps_lsx);
            translate_register_lsx(dt_X86_INS_VPALIGNR,
                                   translate_vpalignr_lsx);
            translate_register_lsx(dt_X86_INS_VPBLENDD,
                                   translate_vpblendd_lsx);
            translate_register_lsx(dt_X86_INS_VPBLENDVB,
                                   translate_vpblendvb_lsx);
            translate_register_lsx(dt_X86_INS_VPBLENDW,
                                   translate_vpblendw_lsx);
            translate_register_lsx(dt_X86_INS_VPERM2F128,
                                   translate_vperm2f128_lsx);
            translate_register_lsx(dt_X86_INS_VPERM2I128,
                                   translate_vperm2i128_lsx);
            translate_register_lsx(dt_X86_INS_VPERMD,
                                   translate_vpermd_lsx);
            translate_register_lsx(dt_X86_INS_VPERMILPD,
                                   translate_vpermilpd_lsx);
            translate_register_lsx(dt_X86_INS_VPERMILPS,
                                   translate_vpermilps_lsx);
            translate_register_lsx(dt_X86_INS_VPERMPD,
                                   translate_vpermpx_lsx);
            translate_register_lsx(dt_X86_INS_VPERMPS,
                                   translate_vpermpx_lsx);
        ...
        if (!option_enable_lasx) {
            ...
            translate_register_lsx(dt_X86_INS_VUNPCKHPD,
                                   translate_vunpckhpd_lsx);
            translate_register_lsx(dt_X86_INS_VUNPCKHPS,
                                   translate_vunpckhps_lsx);
            translate_register_lsx(dt_X86_INS_VUNPCKLPD,
                                   translate_vunpcklpd_lsx);
            translate_register_lsx(dt_X86_INS_VUNPCKLPS,
                                   translate_vunpcklps_lsx);
            translate_register_lsx(dt_X86_INS_VPSHUFB,
                                   translate_vpshufb_lsx);
            translate_register_lsx(dt_X86_INS_VPSHUFD,
                                   translate_vpshufd_lsx);
            translate_register_lsx(dt_X86_INS_VPSHUFHW,
            ...
            translate_register_lsx(dt_X86_INS_VADDPS,
                                   translate_vaddps_lsx);
            translate_register_lsx(dt_X86_INS_VADDSD,
                                   translate_vaddsd_lsx);
            translate_register_lsx(dt_X86_INS_VADDSS,
                                   translate_vaddss_lsx);
            translate_register_lsx(dt_X86_INS_VSUBPD,
                                   translate_vsubpd_lsx);
            translate_register_lsx(dt_X86_INS_VSUBPS,
                                   translate_vsubps_lsx);
            translate_register_lsx(dt_X86_INS_VSUBSD,
                                   translate_vsubsd_lsx);
            translate_register_lsx(dt_X86_INS_VSUBSS,
                                   translate_vsubss_lsx);
            translate_register_lsx(dt_X86_INS_VMULPD,
                                   translate_vmulpd_lsx);
            translate_register_lsx(dt_X86_INS_VMULPS,
                                   translate_vmulps_lsx);
            translate_register_lsx(dt_X86_INS_VMULSS,
                                   translate_vmulss_lsx);
            translate_register_lsx(dt_X86_INS_VDIVPD,
                                   translate_vdivpd_lsx);
            translate_register_lsx(dt_X86_INS_VDIVPS,
                                   translate_vdivps_lsx);
            translate_register_lsx(dt_X86_INS_VDIVSS,
                                   translate_vdivss_lsx);
            translate_register_lsx(dt_X86_INS_VANDNPD,
                                   translate_vandnpd_lsx);
            translate_register_lsx(dt_X86_INS_VANDNPS,
                                   translate_vandnps_lsx);
            translate_register_lsx(dt_X86_INS_VANDPD,
                                   translate_vandpd_lsx);
            translate_register_lsx(dt_X86_INS_VANDPS,
                                   translate_vandps_lsx);
            translate_register_lsx(dt_X86_INS_VORPD,
                                   translate_vorpd_lsx);
            translate_register_lsx(dt_X86_INS_VORPS,
                                   translate_vorps_lsx);
            translate_register_lsx(dt_X86_INS_VXORPS,
                                   translate_vxorps_lsx);
            translate_register_lsx(dt_X86_INS_VXORPD,
                                   translate_vxorpd_lsx);
            translate_register_lsx(dt_X86_INS_VADDSUBPD,
                                   translate_vaddsubpd_lsx);
            translate_register_lsx(dt_X86_INS_VADDSUBPS,
                                   translate_vaddsubps_lsx);
            translate_register_lsx(dt_X86_INS_VHADDPD,
                                   translate_vhaddpd_lsx);
            translate_register_lsx(dt_X86_INS_VHADDPS,
                                   translate_vhaddps_lsx);
            translate_register_lsx(dt_X86_INS_VHSUBPD,
                                   translate_vhsubpd_lsx);
            translate_register_lsx(dt_X86_INS_VHSUBPS,
                                   translate_vhsubps_lsx);
            translate_register_lsx(dt_X86_INS_VMAXPD,
                                   translate_vmaxpd_lsx);
            translate_register_lsx(dt_X86_INS_VMAXPS,
                                   translate_vmaxps_lsx);
            translate_register_lsx(dt_X86_INS_VMAXSD,
                                   translate_vmaxsd_lsx);
            translate_register_lsx(dt_X86_INS_VMAXSS,
                                   translate_vmaxss_lsx);
            translate_register_lsx(dt_X86_INS_VMINPD,
                                   translate_vminpd_lsx);
            translate_register_lsx(dt_X86_INS_VMINPS,
                                   translate_vminps_lsx);
            translate_register_lsx(dt_X86_INS_VMINSD,
                                   translate_vminsd_lsx);
            translate_register_lsx(dt_X86_INS_VMINSS,
                                   translate_vminss_lsx);
            translate_register_lsx(dt_X86_INS_VRCPPS,
                                   translate_vrcpps_lsx);
            translate_register_lsx(dt_X86_INS_VRCPSS,
                                   translate_vrcpss_lsx);
            translate_register_lsx(dt_X86_INS_VRSQRTPS,
                                   translate_vrsqrtps_lsx);
            translate_register_lsx(dt_X86_INS_VRSQRTSS,
                                   translate_vrsqrtss_lsx);
            translate_register_lsx(dt_X86_INS_VSQRTPD,
                                   translate_vsqrtpd_lsx);
            translate_register_lsx(dt_X86_INS_VSQRTPS,
                                   translate_vsqrtps_lsx);
            translate_register_lsx(dt_X86_INS_VSQRTSD,
                                   translate_vsqrtsd_lsx);
            translate_register_lsx(dt_X86_INS_VSQRTSS,
                                   translate_vsqrtss_lsx);
            translate_register_lsx(dt_X86_INS_VDPPD,
                                   translate_vdppd_lsx);
...
#define LATX_AVX_INTEGER_REMAINING_3OP_LSX_REGISTER(opcode, name, lsx_op) \
        translate_register_lsx(dt_X86_INS_##opcode, \
                               translate_v##name##_lsx);
...
#undef LATX_AVX_INTEGER_REMAINING_3OP_LSX_REGISTER
        ...
        translate_register_lsx(dt_X86_INS_VPMADDUBSW,
                               translate_vpmaddubsw_lsx);
        translate_register_lsx(dt_X86_INS_VPMADDWD, translate_vpmaddwd_lsx);
        translate_register_lsx(dt_X86_INS_VPMULHRSW,
                               translate_vpmulhrsw_lsx);
        translate_register_lsx(dt_X86_INS_VPHADDD, translate_vphaddd_lsx);
        translate_register_lsx(dt_X86_INS_VPHADDSW,
                               translate_vphaddsw_lsx);
        translate_register_lsx(dt_X86_INS_VPHADDW, translate_vphaddw_lsx);
        translate_register_lsx(dt_X86_INS_VPHSUBD, translate_vphsubd_lsx);
        translate_register_lsx(dt_X86_INS_VPHSUBSW,
                               translate_vphsubsw_lsx);
        translate_register_lsx(dt_X86_INS_VPHSUBW, translate_vphsubw_lsx);
        translate_register_lsx(dt_X86_INS_VPHMINPOSUW,
                               translate_vphminposuw_lsx);
        translate_register_lsx(dt_X86_INS_VPMOVMSKB,
                               translate_vpmovmskb_lsx);
        translate_register_lsx(dt_X86_INS_VPMOVSXBD,
                               translate_vpmovsxxx_lsx);
        translate_register_lsx(dt_X86_INS_VPMOVSXBQ,
                               translate_vpmovsxxx_lsx);
        translate_register_lsx(dt_X86_INS_VPMOVSXBW,
                               translate_vpmovsxxx_lsx);
        translate_register_lsx(dt_X86_INS_VPMOVSXDQ,
                               translate_vpmovsxxx_lsx);
        translate_register_lsx(dt_X86_INS_VPMOVSXWD,
                               translate_vpmovsxxx_lsx);
        translate_register_lsx(dt_X86_INS_VPMOVSXWQ,
                               translate_vpmovsxxx_lsx);
        translate_register_lsx(dt_X86_INS_VPMOVZXBD,
                               translate_vpmovzxxx_lsx);
        translate_register_lsx(dt_X86_INS_VPMOVZXBQ,
                               translate_vpmovzxxx_lsx);
        translate_register_lsx(dt_X86_INS_VPMOVZXBW,
                               translate_vpmovzxxx_lsx);
        translate_register_lsx(dt_X86_INS_VPMOVZXDQ,
                               translate_vpmovzxxx_lsx);
        translate_register_lsx(dt_X86_INS_VPMOVZXWD,
                               translate_vpmovzxxx_lsx);
        translate_register_lsx(dt_X86_INS_VPMOVZXWQ,
                               translate_vpmovzxxx_lsx);
        translate_register_lsx(dt_X86_INS_VPSADBW, translate_vpsadbw_lsx);
        translate_register_lsx(dt_X86_INS_VMPSADBW,
                               translate_vmpsadbw_lsx);
        translate_register_lsx(dt_X86_INS_VPANDN, translate_vpandn_lsx);
        ...
        translate_register_lsx(dt_X86_INS_VPTEST, translate_vptest_lsx);
